...
// /**
//  * @function handleOath
//  * @description Handles OATH device management operations such as getting and deleting devices
//  * @param {DeviceClient} client A device client instance from the JS SDK
//  * @returns {Effect.Effect<void, Error, never>} An Effect that performs OATH device management operations
//  */
// function handleOath(client: DeviceClient): Effect.Effect<void, Error, never> {
...
// Effect.runPromise(autoscript(handleOath)).then(console.log, handleError);
