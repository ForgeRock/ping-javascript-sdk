...
// @public
export type UpdatableCollectors = SingleValueCollectors | MultiSelectCollector | ObjectValueCollectors | AutoCollectors;
...
// @public
export type Updater<T extends UpdatableCollectors = UpdatableCollectors> = (value: CollectorValueType<T>, index?: number) => InternalErrorResponse | null;
