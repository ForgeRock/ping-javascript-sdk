...
export type AutoCollectorTypes = 'SingleValueAutoCollector' | 'ProtectCollector';

export interface SingleValueAutoCollector<T extends AutoCollectorTypes> {
  category: 'AutoCollector';
  error: string | null;
  type: T;
  id: string;
  name: string;
...
export type AutoCollectors =
  | SingleValueAutoCollector<'ProtectCollector'>
  | SingleValueAutoCollector<'SingleValueAutoCollector'>;

export type ProtectCollector = SingleValueAutoCollector<'ProtectCollector'>;
