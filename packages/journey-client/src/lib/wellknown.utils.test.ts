...
describe('wellknown.utils', () => {
  describe('convertWellknown', () => {
    ...
    describe('convertWellknown_NonAmIssuer_Throws', () => {
      it('should throw when issuer does not contain /oauth2/', () => {
        // Arrange
        const data = createMockWellknown({
        ...
        // Act & Assert
        expect(() => convertWellknown(data)).toThrow('ForgeRock AM issuer');
      });
    });

    describe('convertWellknown_MissingAuthEndpoint_Throws', () => {
      it('should throw when authorization_endpoint is missing', () => {
        ...
        // Act & Assert
        expect(() => convertWellknown(data)).toThrow('authorization_endpoint');
      });
    });
