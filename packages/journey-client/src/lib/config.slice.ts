 ...
 * Carries the already-resolved server config (produced by `convertWellknown`
 * in the imperative shell) alongside any user-provided middleware.
 */
 ...
 * The `set` action stores the pre-resolved config produced by `convertWellknown()`.
 */
