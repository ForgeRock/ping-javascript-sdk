...
describe('token-storage', () => {
  ...
  const mockConfig: LegacyConfigOptions = {
  ...
  describe('getTokens', () => {
    ...
    it('should return error when clientId is missing with custom tokenStore', async () => {
      const configWithoutClientId: LegacyConfigOptions = {
        tokenStore: {
    ...
    it('should use localStorage by default', async () => {
      const configWithoutStore: LegacyConfigOptions = { clientId: 'test-client' };
    ...
    it('should use sessionStorage when specified', async () => {
      const sessionConfig: LegacyConfigOptions = {
        clientId: 'test-client',
  ...
  describe('removeTokens', () => {
    ...
    it('should return error for invalid token store type', async () => {
      const invalidConfig: LegacyConfigOptions = {
        clientId: 'test-client',
