...
export const RECOGNIZE_SDK_TO_RECOGNIZE_PROXY_ERROR_MAP: Record<string, RecognizeErrorCode> =
  Object.freeze({
    ...
    KEY_DECODE_FAILED: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
    KEY_UNSET: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
    KEY_ID_UNSET: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
    USERNAME_UNSET: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
    WEB_SOCKET_URL_PARSE_FAILED: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
    WEB_SOCKET_URL_UNSET: RecognizeErrorCode.SDK_INVALID_CONFIGURATION,
